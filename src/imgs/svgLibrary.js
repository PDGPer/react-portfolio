...
export const Year0Img = () => {
    return (
        <div className="animation-container">
            <div className="forest-animation-right" />
            <div className="forest-animation-left" />
            <div className="forest-animation-glow" />
            <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            >
                <defs>
                    ...
                    <linearGradient id="b">
                        <stop offset="0" stopColor="#f9d618"></stop>
                        <stop
                            offset="1"
                            stopColor="#f9d618"
                            stopOpacity="0"
                    ...
                    <linearGradient id="a">
                        <stop offset="0" stopColor="#1c0e1a"></stop>
                        <stop offset="1"></stop>
                    </linearGradient>
                    <linearGradient
                        id="d"
                        ...
                        y1="191.263"
                        y2="191.263"
                        gradientTransform="matrix(.544 0 0 1.79231 -265.689 -210.52)"
                ...
                <path
                    fill="url(#d)"
                    d="M-265.2-.249h142.09v265.064H-265.2z"
                    transform="rotate(-90)"
                ></path>
                <path
                    d="M167.263 42.225l9.422-.846s-14.222 127.647-56.348 152.836c-42.127 25.19-46.193 32.027-58.499 77.65-12.306 45.624.862 43.653.862 43.653l-22.456-.625.05-274.928z"
                    style={{ mixBlendMode: "color" }}
                    fill="#171313"
                ></path>
                <path
                    d="M129.93 180.617l-40.846 85.046 96.185-.086-45.68-88.55z"
                    style={{ mixBlendMode: "normal" }}
                    fill="url(#e)"
                    opacity="0.281"
                ></path>
                <path
                    d="M102.04 35.893l126.97-2.26.05 274.929-22.456.624s13.168 1.972.862-43.652-16.372-52.46-58.499-77.65C106.841 162.694 92.62 35.047 92.62 35.047z"
                    style={{ mixBlendMode: "color" }}
                    fill="#171313"
                ></path>
                <path
                    d="M118.315 21.885l126.97-2.26.05 274.929-22.456.624s13.168 1.972.862-43.652-16.372-52.461-58.499-77.65c-42.127-25.19-56.348-152.837-56.348-152.837z"
                    style={{ mixBlendMode: "normal" }}
                    fill="#090c09"
                ></path>
                <path
                    fill="#121410"
                    d="M147.615 29.372l9.422-.846s-14.222 127.648-56.348 152.837c-42.127 25.189-46.193 32.026-58.499 77.65-12.306 45.624.862 43.652.862 43.652l-22.456-.624.05-274.929z"
                ></path>
                <path
                    d="M121.222 18.961l126.97-2.26.05 274.928-22.457.624s13.168 1.972.862-43.651c-12.306-45.624-16.372-52.461-58.498-77.65C126.022 145.761 111.8 18.114 111.8 18.114z"
                    style={{ mixBlendMode: "normal" }}
                    fill="#191b14"
                ></path>
                <path
                    fill="#20231c"
                    d="M145.535 24.185l9.421-.846s-14.221 127.648-56.348 152.837c-42.126 25.189-46.192 32.026-58.498 77.65-12.306 45.624.862 43.652.862 43.652l-22.457-.624.05-274.929z"
                ></path>
                <path
                    d="M128.502 16.79l126.969-2.26.05 274.928-22.456.624s13.168 1.972.862-43.652c-12.306-45.623-16.372-52.46-58.499-77.65-42.126-25.19-56.348-152.836-56.348-152.836z"
                    style={{ mixBlendMode: "normal" }}
                    fill="#24291f"
                ></path>
                <path
                    fill="#2c3329"
                    d="M140.348 11.522l9.421-.846s-14.221 127.647-56.348 152.836c-42.127 25.19-46.193 32.027-58.499 77.65-12.306 45.624.862 43.652.862 43.652l-22.456-.624.05-274.928z"
                ></path>
                <path
                    d="M138.582-.14L265.55-2.4l.05 274.928-22.456.625s13.168 1.971.862-43.652c-12.306-45.624-16.372-52.461-58.499-77.65C143.382 126.66 129.16-.987 129.16-.987z"
                    style={{ mixBlendMode: "normal" }}
                    fill="#353b2e"
                ></path>
                <path
                    fill="#3e4536"
                    d="M125.504-6.723l9.422-.846s-14.221 127.647-56.348 152.837c-42.127 25.189-46.193 32.026-58.499 77.65-12.306 45.624.862 43.652.862 43.652l-22.456-.624.05-274.93z"
                ></path>
                <path
                    fill="#54604d"
                    d="M102.801-37.508l9.422-.846S98.002 89.293 55.875 114.482c-42.127 25.19-46.193 32.027-58.499 77.65-12.306 45.624.862 43.652.862 43.652l-22.456-.624.05-274.928z"
                ></path>
                <path
                    d="M164.934-36.74L291.904-39l.05 274.928-22.457.624s13.168 1.972.862-43.652-16.372-52.46-58.498-77.65c-42.127-25.19-56.348-152.837-56.348-152.837z"
                    style={{ mixBlendMode: "normal" }}
                    fill="#3d4736"
                ></path>
                <path
                    fill="#5c6954"
                    d="M66.425-80.348l9.421-.846S61.626 46.453 19.498 71.642C-22.628 96.832-26.694 103.67-39 149.292c-12.306 45.624.862 43.652.862 43.652l-22.457-.624.051-274.928z"
                ></path>
                <path
                    d="M200.835-86.283l126.969-2.26.05 274.929-22.456.624s13.168 1.972.862-43.652-16.372-52.461-58.498-77.65C205.635 40.518 191.414-87.13 191.414-87.13z"
                    style={{ mixBlendMode: "normal" }}
                    fill="#464e3e"
                ></path>
                <circle
                ...
                ></circle>
                <path
                    d="M135.634 167.442l-5.755 13.492 6.169 13.853 5.424-14.058z"
                    style={{ mixBlendMode: "hard-light" }}
                    fill="#f9d618"
                ></path>
                <path
                    d="M149.015 227.15l1.789 1.352-2.48 1.615-3.12 3.518-.984 5.376-2.628 7.528-1.691 2.655.692 1.466 2.712-2.567 3.191-7.805 2.116-4.818-1.225 6.923-.333 5.276-.777 4.031-1.877 6.483-1.987 5.502-2.353 3.07 4.825-1.239 4.19-6.89 2.703-8.437 1.522 6.913.661 4.229-.409 4.419 3.118-.305.588-7.113-.566-11.83 2.643-11.043.743-3.095L159 229.42l-2.444-1.492 1.596-7.285-3.746-3.203-3.684 1.718c-.846 2.74-1.265 5.03-1.708 7.992z"
